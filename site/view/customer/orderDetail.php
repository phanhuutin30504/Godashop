            ...
            <div class="col-md-9 order-info">
                <div class="row">
                    ...
                    <aside class="col-md-7 cart-checkout">
                        <div class="row">
                            <div class="col-xs-2">
                                <img class="img-responsive" src="../upload/suaTamSandrasMychai250ml.jpg"
                        ...
                        <div class="row">
                            <div class="col-xs-2">
                                <img class="img-responsive" src="../upload/kemDuongTrangDaNgayVaDem.jpg"
                                    alt="Kem Dưỡng Trắng Da Ngày vs Đêm">
                            </div>
                            <div class="col-xs-7">
                        ...
                        <div class="row">
                            <div class="col-xs-2">
                                <img class="img-responsive" src="../upload/kemNenTrangDiemDuongDaSandrasBB.jpg"
                                    alt="Kem nền trang điểm dưỡng da Sandras BB 24h- 15ml">
                            </div>
                            <div class="col-xs-7">
                                <a class="product-name" href="chi-tiet-san-pham.html">Kem nền trang điểm dưỡng da
                                    Sandras BB 24h- 15ml</a>
                                <br>
